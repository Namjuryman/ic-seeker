...
const cards = [
  {
    ...
    title: '企业对比',
    description: '横向比较公司类型、技术方向、产品领域、岗位信号和学习路线关联。',
    icon: 'C',
  ...
  },
  {
    ...
    title: '机构对比',
    description: '比较机构在论文、方向、活跃作者和代表成果上的结构化差异。',
    icon: 'I',
  ...
  },
  {
    to: '/compare/authors',
    title: '学者对比',
    description: '比较研究者的发文方向、会议期刊分布、合作网络和代表论文。',
    icon: 'A',
  ...
  },
  {
    to: '/compare/mentors',
    title: '导师画像对比',
    description: '使用通过审核且达到阈值的匿名评价和公开论文 metadata 做并列比较。',
    icon: 'M',
    ...
    <div className="max-w-7xl mx-auto space-y-5">
      <section className="bg-surface-panel border border-line rounded-xl p-5 shadow-sm">
        <div>
          ...
          <p className="text-sm text-ink-muted mt-1">
            面向科研、申请和职业规划的并列比较与方向报告。这里做结构化辅助判断，不做绝对排名。
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface-panel border border-line rounded-xl p-5 shadow-sm">
        <p className="text-xs text-ink-subtle leading-relaxed">
          Comparisons are based on available metadata and approved user signals. They are side-by-side exploration tools,
          not final rankings, blacklists, investment advice, or definitive evaluations of people, institutions, or companies.
        </p>
      </section>
    </div>
  )
