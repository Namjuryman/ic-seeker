...
const messages = {
  ...
  en: {
    'nav.section.product': 'SiliconScope',
    'nav.search': 'Paper Search',
    'nav.intelligence': 'Intelligence Hub',
    'nav.learning': 'Learning Workspace',
    'nav.workspace': 'Workspace',
    'nav.account': 'Account & Platform',
    'nav.theme': 'Theme',
    ...
    'login.error': 'Login failed. Check the admin password.',
