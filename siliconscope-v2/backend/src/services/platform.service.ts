...
const modules: PlatformModule[] = [
  ...
  },
  {
    ...
    status: "ready",
    maturity: 78,
    summary: "Route library, daily lessons, and a database-backed learning content registry are in place for IC self-study and mobile-style learning.",
    shipped: ["route families", "common foundations", "daily lessons", "related papers", "admin content sync"],
    next: ["structured content editor", "progress tracking", "spaced review", "reading queue handoff"],
  },
  {
    id: "geo-venue",
  ...
  {
    id: "content-quality",
    name: "Content Quality and Knowledge Graph",
    track: "operations",
    status: "planned",
    maturity: 28,
  ...
  getOverview() {
    ...
    return {
      ...
      nextMilestones: [
        ...
        "Add a content-quality graph for topic hierarchy, source-backed entity claims, and weekly content diffs.",
