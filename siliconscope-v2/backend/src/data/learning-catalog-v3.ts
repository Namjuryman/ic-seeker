...
export const routeFamilies: RouteFamilySeed[] = [
  {
    id: "circuit",
    title: "Circuit Design Routes",
    description: "Transistor-level and system-facing circuit routes: analog, converters, clocking, wireline, RF, PMIC, and sensing.",
    routeIds: ["analog-mixed-signal", "data-converters", "clocking-pll-timing", "wireline-serdes", "rf-mmwave", "power-management", "sensor-bio-interface"],
  },
  {
    id: "digital-system",
  ...
  {
    id: "cad-security",
    title: "Tools, Trust, and Productization Routes",
