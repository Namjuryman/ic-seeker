...
export function countryFeatureCode(code) {
...
export const geoHotspotProfiles = {
  US: [
...
export function projectWorldPoint(lon, lat) {
...
export function geoCountryAnchor(country) {
...
export function prepareWorldMap(geojson) {
...
export function geoHotspots(country, max, metric) {
